...
def MACD_UP_AFTER_GREEN_K3(OPEN, CLOSE, MACD, I):
    ...
    c_macd = MACD[I]
    p_macd = MACD[I - 1]
    return green_k3 and c_macd > 0 and p_macd > 0 and c_macd > p_macd
...
def MACD_DOWN_AFTER_RED_K3(OPEN, CLOSE, MACD, I):
    ...
    c_macd = MACD[I]
    p_macd = MACD[I - 1]
    return red_k3 and c_macd < 0 and p_macd < 0 and c_macd < p_macd

# MACD首次大于前一天，MACD未溢出，转多
def MACD_UP_V(MACD, DEA, I):
    return MACD[I] > DEA[I] and MACD[I] > 0 and MACD[I - 1] > 0 and MACD[I] > MACD[I - 1] and MACD[I - 1] < MACD[I - 2]
